...
const TRACK1_DAYS: ScheduleDay[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "10:00 – 11:30", title: "기관 방문 (해양수산·창업 중간지원조직)", venue: "Partners Program, 20 Cecil St", highlight: true },
      { time: "12:00", title: "점심식사" },
      { time: "15:00 – 16:30", title: "PoC 현장 방문 (항만·선사·조선)", venue: "10 Anson Road #36-12, International Plaza", highlight: true },
  ...
  },
  {
    ...
    items: [
      { title: "[기업 자율] 비즈니스 밋업", venue: "Nuldam Space, 2 Orchard Link #02-14/15" },
      { time: "12:00", title: "점심식사 · 기업 자부담" },
      { title: "[기업 자율] 비즈니스 밋업", venue: "Nuldam Space, 2 Orchard Link #02-14/15, SCAPE" },
  ...
  },
  {
    ...
    items: [
      { title: "EMA-MARINE 비즈니스 밋업 데이", venue: "Suntec Singapore Convention & Exhibition Centre, Level 3, Room 302, 1 Raffles Boulevard 039593", highlight: true },
      { time: "17:00", title: "집결 및 이동" },
  ...
  },
  {
    ...
    items: [
      { time: "9:00", title: "집결 및 이동" },
      { time: "10:00 – 11:30", title: "PIER71 방문 (해양수산·창업 중간지원조직)", venue: "PIER71 (BLOCK71 Singapore)", highlight: true },
      { time: "12:00", title: "점심식사" },
      { time: "15:00 – 17:00", title: "PoC 현장 방문 (항만·선사·조선) · ACE", venue: "ACE (3pm–5pm)", highlight: true },
      { time: "18:00", title: "KOCHAM 갈라 디너", venue: "W Singapore – Sentosa Cove, 21 Ocean Way 098374", highlight: true },
    ],
  },
  {
...
const TRACK2_DAYS: ScheduleDay[] = [
  ...
  },
  {
    ...
    items: [
      { title: "집결 및 이동" },
      { time: "10:00 – 12:00", title: "기관 방문: Innovate 360 (참여 인원 5)", venue: "2 Orchard Link #02-14/15, SCAPE", highlight: true },
      { time: "12:00", title: "점심식사" },
      { time: "14:00 – 17:00", title: "[파트너 매칭] 비즈니스 밋업 (기업당 2~3인)", venue: "Nuldam Space, 2 Orchard Link #02-14/15, SCAPE 237978", highlight: true },
      { time: "18:00", title: "저녁식사 및 비즈니스 밋업 성과/후기 정리" },
      { title: "휴식" },
    ],
  },
  ...
  { date: "9/6", dow: "일", theme: "자유일정", free: true, items: [] },
  {
    ...
    items: [
      ...
      { title: "[기업 자율] 비즈니스 밋업" },
      { time: "12:00", title: "점심식사 · 기업 자부담" },
      { time: "14:00 – 17:00", title: "[기업 자율] 비즈니스 밋업", venue: "Nuldam Space, 2 Orchard Link #02-14/15, SCAPE 237978", highlight: true },
  ...
  },
  {
    ...
    items: [
      { title: "집결 및 이동" },
      { time: "10:00 – 11:00", title: "기관 방문: EDB", venue: "Raffles City Tower, Level 28", highlight: true },
      { time: "12:00", title: "점심식사" },
